...
NGA Reminder monitors NGA threads and users, saves content, and sends notifications. The Go rewrite has completed phases 01–08: a passwordless LAN admin page, TID/UID monitoring and scheduling, Bark/Feishu notifications, a Feishu bot, Cookie renewal, content browsing and Markdown/ZIP export, resource maintenance, reply history backfill, and floor gap recovery. Data migration and deployment remain in phases 09–10.

## Repository

| Directory | Status | Purpose |
| --- | --- | --- |
| [`service/`](service/docs/README.md) | Phases 01–08 complete | Single-process Go server using Gin, GORM, pure Go SQLite, and zerolog, with CGO disabled |
