...
> Historical repository documentation for Rust v0.1.4. See the [archive index](ARCHIVE.md) for current paths and release status. The Go rewrite will be designed separately.
